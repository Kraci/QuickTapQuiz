    ...
    private fun parseQuizGame(quizGameDB: List<QuizGameDao.QuizGameDB>): QuizGame? {
        ...
        for (quizGameRow in quizGameDB) {
            if (actualCategory.name != quizGameRow.category_name) {
                ...
                actualCategory =
                        CategoryGame(quizGameRow.category_name, mutableListOf())
                actualQuestions = mutableListOf()
            }
            val question = QuestionGame(
                quizGameRow.question_text,
                quizGameRow.question_hint,
                quizGameRow.question_image,
                quizGameRow.question_value,
                quizGameRow.question_bonus
            )
