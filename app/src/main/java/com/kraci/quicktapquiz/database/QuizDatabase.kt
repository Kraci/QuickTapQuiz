...
//        }
        ...
        fun populateDatabase(quizDao: QuizDao, categoryDao: CategoryDao, questionDao: QuestionDao, categoryQuestionDao: CategoryQuestionDao) {
            ...
            var categoryQuestion =
                CategoryQuestion(categoryID.toInt(), questionID.toInt(), 500, false)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 1500, true)
            categoryQuestionDao.insert(categoryQuestion)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 2000, true)
            categoryQuestionDao.insert(categoryQuestion)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 500, true)
            categoryQuestionDao.insert(categoryQuestion)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 5000, true)
            categoryQuestionDao.insert(categoryQuestion)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 300, false)
            categoryQuestionDao.insert(categoryQuestion)

            question = Question(text = "Question52", hint = "hint52", image = "")
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 600, false)
            categoryQuestionDao.insert(categoryQuestion)
            ...
            questionID = questionDao.insert(question)
            categoryQuestion =
                    CategoryQuestion(categoryID.toInt(), questionID.toInt(), 1, false)
            categoryQuestionDao.insert(categoryQuestion)
